...
这一课继续讲解 Object-Oriented Programming，进入第三个核心概念：polymorphism。和前两课的 encapsulation、inheritance 不同，多态是更“纯正”的面向对象特性，在传统过程式语言 C 里没有直接对应物，因此这一课的讲法也反过来了：先看 C++ 中多态到底是什么、解决什么问题、底层如何实现；下一课再去看如何在 C 中模拟它。
